...
const Edit = () => {
  ...
  return (
    <div className="flex flex-col gap-9 items-center justify-center pt-20 w-screen">
      <div className="w-full flex flex-col justify-center items-center gap-2">
        <h1 className="capitalize text-5xl text-gray-100">edit contact</h1>
        <p className=" text-sm w-9/12 md:w-1/2 lg:w-1/4 text-gray-400 text-center">
          Enter the details of your conatct to edit them in the Contact Book
        </p>
      </div>
      {currentContact ? (
        <form
  ...
  transitional"
        ...
        <h2 className="capitalize text-2xl text-red-300 animate-bounce hover:animate-none transitional">
